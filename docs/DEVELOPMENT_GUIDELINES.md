...
Planned:
- **Hide/show object feature. (0.3.0)** This quality of life feature would help focusing on specific objects during design. It is not set yet if this will be saved or not.
